...
export const uiText = {
  id: {
    ...
    sendSuccess: "Terima kasih, pesan Anda sudah terkirim. Kami akan segera menghubungi Anda.",
    sendError: "Pesan gagal terkirim. Silakan coba lagi atau hubungi kami lewat email.",
  ...
  en: {
    ...
    sendSuccess: "Thank you, your message has been sent. We'll get back to you soon.",
    sendError: "Message failed to send. Please try again or email us directly.",
